...
| 23a | Cyborgizacje i człowieczeństwo                | 🟨     |                 | etap 23 podzielony na 23a/23b/23c 09.08                                                       |
| 23b | Ekonomia: eurodolce, zakupy, lifestyle        | ⬜     |                 | instalacja cyborgizacji pobierze cenę dopiero tutaj                                           |
| 23c | Reputacja i Facedown                          | ⬜     |                 | niezależny od 23a/23b — kolejność dowolna                                                     |
...
Ostatnio zamknięte: **23a** (cyborgizacje z kompendium, rzut na Utratę Człowieczeństwa na serwerze, EMP bieżące w rzutach, progi cyberpsychozy, terapia). **Faza H otwarta.**
...
Następny etap: **23b — ekonomia: eurodolce, zakupy, lifestyle** (`etap-23b-ekonomia-lifestyle.md`). Tam czeka domknięcie 23a: instalacja cyborgizacji pokazuje cenę, ale jej **nie pobiera**. Alternatywnie 23c (reputacja, niezależny) albo 24–27 — kolejność w fazie H jest dowolna.
