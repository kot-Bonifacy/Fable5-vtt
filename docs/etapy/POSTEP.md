...
Ostatnio zamknięte: **23b** (eurodolce jako operacja serwera z audytem, zakup z kompendium, przelewy, Poziom życia i „Rozlicz miesiąc"; przy okazji domknięte 23a — instalacja i terapia pobierają cenę). **Faza H otwarta.**
...
Następny etap: **23c — reputacja i Facedown** (`etap-23c-reputacja-facedown.md`), niezależny od 23a/23b. Alternatywnie 24–27 — kolejność w fazie H jest dowolna.
