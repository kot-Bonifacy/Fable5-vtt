...
| 24b | Dziennik kampanii dla stołu                   | ⬜     |                 | trzeci stan widoczności wpisu 19c + oś czasu i wyszukiwarka                                    |
...
Ostatnio zamknięte: **24a** (handouty: grafika z uploadu i tekst markdown, udostępnianie wybranym graczom, okno wyskakujące u odbiorcy, zakładka „Handouty" dla całego stołu).

**Etap 24 podzielony 09.08 na 24a/24b/24c** (decyzja MG) — trzy niezależne funkcje w jednym opisie. Następny etap: **24b (dziennik kampanii dla stołu)** — trzeci stan widoczności wpisu z 19c, oś czasu, wyszukiwarka i linki do handoutów. Potem **24c (screamsheets)**, który publikuje się drogą z 24a. Reszta fazy H (**25–27**) w dowolnej kolejności.
