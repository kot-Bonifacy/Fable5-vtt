# Etap 15 — Obrażenia, pancerz, krytyki, Death Save

**Faza:** D — Walka · **Wymaga etapów:** 13, 14
...
- DV wg odległości i autofire (etap 16), leczenie/stabilizacja jako pełna mechanika (ręcznie przez MG; First Aid ewentualnie do POMYSLY.md)
...
- Wszystkie liczby i teksty reguł pobieraj z danych (etap 13), nie hardkoduj — w publicznym repo zostają tylko wzory
