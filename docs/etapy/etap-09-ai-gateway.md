...
- [x] Serwer VTT: moduł `ai-client` (adres gatewaya z env — dziś localhost, po etapie 28 adres w tailnecie), health-check cykliczny, status botów w UI (dostępne/offline)
...
- [x] Pomiar: tokens/s i zużycie VRAM zapisane w `ai-gateway/README.md` (decyzja nt. rezerwy pod whisper w etapie 21)
