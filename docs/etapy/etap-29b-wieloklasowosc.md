...
- [x] **Lista Ról na karcie** — `roleId` przestaje być jedynym miejscem; bieżąca Rola zostaje
      tą, przez którą widzi cię Ulica, poprzednie zostają z własnymi rangami
- [x] **Bramka zmiany Roli** — Zdolność Roli **bieżącej** ≥ 4; przy trzeciej Roli pyta się
      o drugą, nie o pierwszą
- [x] **Nowa Rola startuje od poziomu 1** i kosztuje pierwszy szczebel drabinki Zdolności
      z 29a (60 PD)
- [x] **Stare Zdolności rosną dalej i dalej działają** — „cały czas możesz podnosić poziom
      Zdolności Specjalnej poprzedniej Roli i korzystać z oferowanych przez nią korzyści"
- [x] **`cpredRoleAbilityRank` pyta o wszystkie Role**, nie o jedną — to jeden punkt, przez
      który przechodzi wszystkie dziesięć Zdolności z etapu 30
- [x] **Karta pokazuje kilka paneli Zdolności naraz** (Solo + Nomada to Zmysł Walki i Moto
      obok siebie)
- [x] Testy: bramka ≥ 4 przy drugiej i trzeciej Roli, nowa Rola od 1, stara rośnie dalej,
...
- [x] Druga Rola daje się dodać dopiero przy Zdolności bieżącej Roli ≥ 4 i startuje od
      poziomu 1
- [x] Solo, który został Nomadą, ma na karcie działający Zmysł Walki **i** Moto
- [x] Ulica (Reputacja z 23c, opis żetonu, karta) widzi Rolę nową
