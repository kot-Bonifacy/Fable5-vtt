...
**Faza:** H — Świat CP RED · **Wymaga etapów:** 13, 14, 15

⚠️ **Wymaga materiałów od Ciebie:** rozdział netrunningu (akcje interfejsu, programy, ICE, zasady budowy architektur) przez pipeline z etapu 13.
...
- [ ] Akcje netrunnera: pełen zestaw akcji interfejsu wg podręcznika jako przyciski z automatyką rzutów (testy vs DV, walka programów z lodem przez silnik z etapów 06/15); licznik akcji NET na turę wg zasad (speed interfejsu)
...
- [ ] Czarny lód: statbloki, inicjatywa lodu, ataki na netrunnera (obrażenia „meat" i NET wg zasad — spięte z HP karty przez etap 15)
- [ ] Synchronizacja z walką fizyczną: netrunning w ramach wspólnego trackera inicjatywy z etapu 14 (tura netrunnera = jego akcje NET), reszta drużyny widzi skrót działań na czacie
- [ ] Tryb podglądu MG: pełna architektura + pozycja netrunnera, możliwość ręcznego sterowania lodem

## Poza zakresem

- Netrunning botów-NPC przeciw graczom (bot jako wrogi netrunner — POMYSLY.md, złożenie z etapem 20), efekty wizualne 3D, architektury generowane proceduralnie (POMYSLY.md)
