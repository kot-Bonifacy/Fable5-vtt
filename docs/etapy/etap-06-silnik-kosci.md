...
- [x] Karta wyniku na czacie: formuła, rozbicie (wartości kości, dorzuty krytyka/fumble'a wyróżnione), suma; stylizacja odróżniająca rzut od zwykłej wiadomości
- [x] Testy jednostkowe: parser (przypadki brzegowe), krytyk, fumble, łańcuch dorzutów, wykrycie krytycznych obrażeń
