...
- [x] Ekran logowania po polsku (proste, czytelne — szlif wizualny w etapie 27)
...
- Cookie: `@fastify/cookie` + `@fastify/session` lub podpisany token — wybierz prostsze; HTTPS wymusi się w etapie 28
