...
const ICON_FX: Readonly<Record<CpredSlotIcon, CpredWeaponFx>> = {
  ...
  flamethrower: { style: 'flame', sound: 'shot-shotgun' },
  grenade: { style: 'rocket', sound: 'swing' },
  launcher: { style: 'rocket', sound: 'shot-sniper' },
  rocket: { style: 'rocket', sound: 'shot-sniper' },
  ...
  fist: { style: 'melee', sound: 'swing' },
  'martial-arts': { style: 'melee', sound: 'swing' },
