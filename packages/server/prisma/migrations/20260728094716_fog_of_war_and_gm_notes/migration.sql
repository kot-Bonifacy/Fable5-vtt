...
CREATE TABLE "MapNote" (
    ...
    CONSTRAINT "MapNote_sceneId_fkey" FOREIGN KEY ("sceneId") REFERENCES "Scene" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Scene" (
    ...
    "fogEnabled" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Scene_campaignId_fkey" FOREIGN KEY ("campaignId") REFERENCES "Campaign" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
-- A scene that already existed had no fog and was fully visible; switching it
-- on here would black out a running campaign on upgrade. New scenes still
-- default to covered (the column default) — the GM turns fog off per scene.
INSERT INTO "new_Scene" ("active", "backgroundHeight", "backgroundUrl", "backgroundWidth", "campaignId", "createdAt", "gridAlpha", "gridColor", "gridMode", "gridOffsetX", "gridOffsetY", "gridSizePx", "gridVisible", "height", "id", "metersPerSquare", "name", "updatedAt", "width", "fogEnabled") SELECT "active", "backgroundHeight", "backgroundUrl", "backgroundWidth", "campaignId", "createdAt", "gridAlpha", "gridColor", "gridMode", "gridOffsetX", "gridOffsetY", "gridSizePx", "gridVisible", "height", "id", "metersPerSquare", "name", "updatedAt", "width", false FROM "Scene";
DROP TABLE "Scene";
...
-- CreateIndex
CREATE INDEX "MapNote_sceneId_idx" ON "MapNote"("sceneId");
